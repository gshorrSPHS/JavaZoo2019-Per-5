public class Lacrimation extends GodsTears implements Swimming, Flying
{
    public Lacrimation(String name, String desc)
    {
        super(name, desc);
    }
    @Override 
    ...
    {
        return "Hello darkness, my old frienddandl \n"+
